...
|Board Mounting Hole |穴径3.2mmΦ。OBC周辺の穴はCubeSat向けPC104に対応。
|===
...
|11 |FPJA JTAGコネクタ |Xilinx製のJTAGデバッカを接続できます。
...
[fn:hwopt] : ハードウェアオプションによって電源ドメインが異なります。詳しくは『Space Cubics OBC製品マニュアル』を参照してください。
...
|9 |NC |- |- |未接続
|10 |I2C_EXT_SCL |Out |VDD_3V3_SYS |External I2C クロック
...
CON14はConsoleインタフェースであり、FTDI社製 https://ftdichip.com/products/ft2232h-56q/[FT2232H-56Q] を経由して、FPGAおよびTRCHのUARTポートへ接続が可能です。 +
...
==== VDD_UIO = VDD_3V3_IO
image::VDD_UIO-VDD_3V3_IO.svg[VDD_UIO-VDD_3V3_IO.svg]
==== VDD_UIO = VDD_3V3_DCDC
image::VDD_UIO-VDD_DCDC.svg[VDD_UIO-VDD_DCDC.svg]
==== VDD_UIO = Block Terminal Input
image::VDD_UIO-TRM.svg[VDD_UIO-TRM.svg]
